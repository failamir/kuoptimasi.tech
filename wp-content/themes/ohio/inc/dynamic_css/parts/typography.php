...
if ( $dark_mode_switcher_typo = OhioOptions::get( 'page_dark_mode_switcher_typo' ) ) {
	$dark_mode_switcher_css = OhioHelper::parse_acf_typo_to_css( $dark_mode_switcher_typo );
	if ( $dark_mode_switcher_css ) {
		$_selector = '.elements-bar:not(.light-typo):not(.dark-typo) .color-switcher-item.dark';
		OhioBuffer::pack_dynamic_css_to_buffer( $_selector, $dark_mode_switcher_css );	
	}
}
