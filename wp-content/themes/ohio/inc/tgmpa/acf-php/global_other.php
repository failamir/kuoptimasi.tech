    ...
    acf_add_local_field_group( [
        ...
        "fields" => [
            ...
            [
                ...
                "type" => "true_false",
                "instructions" => __( 'Enable the subscribe popup', 'ohio' ),
                "required" => 0,
                "conditional_logic" => 0,
                "message" => "",
                "default_value" => 0,
            ...
            [
                ...
                "label" => __( 'Popup type', 'ohio' ),
                "name" => "global_subscribe_popup_position",
                "type" => "select",
                "instructions" => __( 'Choose the popup type', 'ohio' ),
                "required" => 0,
                "conditional_logic" => [
                    [
                        [
            ...
            [
                ...
                "label" => __( 'Popup background', 'ohio' ),
                "name" => "global_subscribe_popup_overlay_color",
                "type" => "ohio_color",
                "instructions" => __( 'Choose a background color for the subscribe popup', 'ohio' ),
                "required" => 0,
                "conditional_logic" => [
                    [
                        [
            ...
            [
                ...
                "label" => __( 'Popup featured image', 'ohio' ),
                "name" => "global_subscribe_popup",
                "type" => "clone",
                "instructions" => __( 'Set a featured image for the subscribe popup', 'ohio' ),
                "required" => false,
                "conditional_logic" => [
                    [
                        [
            ...
            [
                ...
                "label" => __( 'Popup featured image position', 'ohio' ),
                "name" => "global_subscribe_popup_image_position",
                "type" => "select",
                "instructions" => __( 'Choose how do you want to align your featured image', 'ohio' ),
                "required" => 0,
                "conditional_logic" => [
                    [
                        [
            ...
            [
                ...
                "label" => '<h4>' . __( 'Appearance Settings', 'ohio') . '</h4>',
                "name" => "",
                "type" => "message",
                "conditional_logic" => [
                    [
            ...
            [
                ...
                "instructions" => __( 'Set up the popup height', 'ohio' ),
                "required" => 0,
                "conditional_logic" => [
                    [
                        [
            ...
            [
                ...
                "type" => "ohio_responsive_height",
                "instructions" => __( 'Set up the popup width', 'ohio' ),
                "required" => 0,
                "conditional_logic" => [
                    [
                        [
            ...
            [
                ...
                "type" => "ohio_color",
                "instructions" => __( 'Choose a color for the popup close button', 'ohio' ),
                "required" => 0,
                "conditional_logic" => [
                    [
                        [
            ...
            [
                ...
                "label" => __( 'Show popup delay', 'ohio' ),
            ...
            [
                ...
                "type" => "text",
                "instructions" => __( 'After expiry, user will see the popup again', 'ohio' ),
                "required" => 1,
                "append" => __( 'days', 'ohio' ),
                "conditional_logic" => [
                    [
            ...
            [
                ...
                "type" => "ohio_typo",
                "instructions" => __( 'Set up typography styles for the popup heading', 'ohio' ),
                "required" => 0,
                "conditional_logic" => [
                    [
                        [
            ...
            [
                ...
                "type" => "ohio_typo",
                "instructions" => __( 'Set up typography styles for the popup details', 'ohio' ),
                "required" => 0,
                "conditional_logic" => [
                    [
                        [
            ...
            [
                ...
                "type" => "ohio_typo",
                "instructions" => __( 'Set up typography styles for the popup form', 'ohio' ),
                "required" => 0,
                "conditional_logic" => [
                    [
                        [
            ...
            [
                ...
                "label" => __( 'Close link', 'ohio' ),
                "name" => "global_subscribe_popup_close_visibility",
                "type" => "true_false",
                "instructions" => __( 'Show the close popup link', 'ohio' ),
                "required" => 0,
                "conditional_logic" => [
                    [
                        [
            ...
            [
                ...
                "type" => "ohio_typo",
                "instructions" => __( 'Set up typography styles for the close popup link', 'ohio' ),
                "required" => 0,
                "conditional_logic" => [
                    [
                        [
