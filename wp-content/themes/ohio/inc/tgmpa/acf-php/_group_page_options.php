    ...
    acf_add_local_field_group( [
        ...
        "fields" => [
            ...
            [
                ...
                "type" => "image_option",
                "instructions" => __( 'Choose layout type for this post page', 'ohio' ),
                "required" => 0,
                "conditional_logic" => 0,
                "image_option_value" => [
                    [
            ...
            [
                ...
                "label" => __( 'Color mode switcher typography', 'ohio' ),
                "name" => "dark_mode_switcher_typo",
                "type" => "ohio_typo",
                "instructions" => __( 'Set up typography styles for color mode switcher', 'ohio' ),
                "required" => 0,
                "default_value" => "inherit",
                "conditional_logic" => 0,
                "add_theme_inherited" => false
            ...
            [
                ...
                "type" => "select",
                "instructions" => __( 'Choose color mode switcher position for this page', 'ohio' ),
                "required" => 0,
                "conditional_logic" => 0,
                "choices" => [
                    "inherit" => __( 'Use from Theme Settings', 'ohio' ),
            ...
            [
                ...
                "label" => __( 'Dynamic colors for light/dark mode', 'ohio' ),
                "name" => "header_dynamic_typography_color",
                "type" => "inherited_checkbox",
                "instructions" => __( 'Dynamically change header\'s elements color for light/dark sections', 'ohio' ),
                "required" => 0,
                "conditional_logic" => 0,
                "custom_labels" => [
                    "inherit" => __( 'Use from Theme Settings', 'ohio' ),
            ...
            [
                ...
                "type" => "inherited_checkbox",
                "instructions" => __( 'Enable sticky header', 'ohio') . '<em> ' . __( '(Note: sticky header won\'t work with enabled fixed header)', 'ohio') . '</em>',
                "required" => 0,
                "conditional_logic" => 0,
                "custom_labels" => [
                    "inherit" => __( 'Use from Theme Settings', 'ohio' ),
            ...
            [
                ...
                "type" => "inherited_checkbox",
                "instructions" => __( 'Dark section mode mode for dynamically changing colors (clb__dark_section HTML class will be added)', 'ohio' ),
                "required" => 0,
                "conditional_logic" => 0,
                "custom_labels" => [
                    "inherit" => __( 'Use from Theme Settings', 'ohio' ),
            ...
            [
                ...
                "name" => "arrow_position",
                "type" => "select",
                "instructions" => __( 'Choose scroll-to-top position for this page', 'ohio' ),
                "required" => 0,
                "conditional_logic" => 0,
                "choices" => [
                    "inherit" => __( 'Use from Theme Settings', 'ohio' ),
